...
/* ===============================
   GAS SYSTEM
=============================== */
import { sendWithGas } from "./utils/gasManager.js";
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      /* ===============================
         GAS SYSTEM EXECUTION
      =============================== */
      const tx = await sendWithGas({
        provider,
        to,
        amount,
        userPrivateKey: wallet.rows[0].private_key
      });
