...
=============================== */
app.get("/", (req, res) => {
  res.send("SXP Backend + HOT/COLD Running 🚀");
});
...
app.get("/admin/hot-wallet", auth, async (req, res) => {
  try {
    ...
    res.status(500).json({ error: "Failed to fetch hot wallet" });
  }
});
